...
void reverse_iteration() {
  ...
  ft::rb_tree<int, ft::pair<int, std::string>, ft::map_get_key<int, ft::pair<int, std::string> > >::reverse_iterator it = tree.rbegin();

  std::cout << "reverse iteration : " << std::endl;

  int i = 0;
  std::map<int, std::string>::reverse_iterator it_ = map.rbegin();
  for (ft::rb_tree<int, ft::pair<int, std::string>, ft::map_get_key<int, ft::pair<int, std::string> > >::reverse_iterator it = tree.rbegin();
       it != tree.rend(); it++)
  {
